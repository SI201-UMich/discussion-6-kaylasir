    ...
    def load_results(self, table):
        ...
        for row in table[1:]:
            ...
            for i in range(1, len(headers)):
                ...
                inner_stats[race_name] = race_time
            race_results[horse_name] = inner_stats
        return race_results
...
###############################################################################
    ...
    def horse_personal_best(self):
        ...
        for horse in self.race_dict:
            fastest_data = self.horse_fastest_race(horse)
            pb_dict[horse]= fastest_data
        return pb_dict
